    ...
    <PageShell
      ...
      subtitle={
        <div className="flex items-center gap-2 flex-wrap">
          <span
            className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full border ${TIMEFRAME_COLORS[goal.timeframe] || TIMEFRAME_COLORS.Custom}`}
          >
            {goal.timeframe}
          </span>
          ...
          <div className="card">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`inline-flex px-2 py-0.5 text-[10px] font-semibold rounded-full border ${TIMEFRAME_COLORS[goal.timeframe] || TIMEFRAME_COLORS.Custom}`}
                >
                  {goal.timeframe}
                </span>
              </div>
