  ...
  const reportTypes = [
    {
      ...
      title: 'Tasks Report',
      description:
        'Export all tasks with detailed information including status, priority, assignments, and dates.',
      icon: (
    ...
    },
    {
      ...
      title: 'Users Report',
      description:
        'Export user statistics with task counts, status breakdown, and performance metrics.',
      icon: (
        <svg
      ...
      <div className="space-y-4">
        ...
        <div className="card bg-primary-light border-primary/20">
          ...
          <div className="text-sm text-slate-300 space-y-2">
            ...
            <p>
              • User reports provide detailed statistics about task assignments and completion rates
            </p>
