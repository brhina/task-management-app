                ...
                <div className="hidden lg:block">
                    <div className="max-w-lg">
                        ...
                        <p className="mt-3 text-slate-300 leading-relaxed">
                            Create your account to access projects, goals, and task insights for your organization.
                        </p>
                        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-4">
                            <div className="text-sm font-semibold text-slate-100">Admin token (optional)</div>
                            <div className="mt-1 text-sm text-slate-400">If you have an invite token, you can register as an admin during sign-up.</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto w-full max-w-md">
                    ...
                    <div className="card p-5 sm:p-6">
                            ...
                            <div className="mb-4 p-3 bg-primary/10 border border-primary/30 rounded-lg">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-sm">
                                        <span className="font-medium text-primary">You've been invited to join an organization!</span>
                                        <span className="text-slate-400 ml-1">Complete your registration to accept.</span>
                                    </div>
                                </div>
                            </div>
                        )}
                        {orgInviteToken && inviteStatus === 'invalid' && (
                            <div className="mb-4 p-3 bg-rose-500/10 border border-rose-500/30 rounded-lg">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-sm">
                                        <span className="font-medium text-rose-400">Invalid or expired invite link.</span>
                        ...
                        <form className="space-y-3.5" onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                {fieldErrors.name && (
                                    <p className="mt-1 text-sm text-rose-200 flex items-center">
                                        <svg className="w-4 h-4 mr-1 text-rose-300" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div>
                                <label htmlFor="password" className="block text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {formData.password && passwordStrength && passwordStrengthLabel && (
                                    <div className="mt-2">
                                        <div className="flex items-center justify-between mb-1">
                                            ...
                                            <span className={`text-xs font-semibold ${passwordStrengthLabel.color}`}>{passwordStrengthLabel.label}</span>
                                        </div>
                                        <div className="w-full bg-white/10 rounded-full h-2 overflow-hidden">
                                            <div className={`h-2 rounded-full transition-all duration-300 ${passwordStrengthLabel.bgColor}`} style={{ width: `${(passwordStrength.score / 5) * 100}%` }}></div>
                                        </div>
                            ...
                            <div>
                                <label htmlFor="confirmPassword" className="block text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">Confirm Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <input
                                        ...
                                        className={`input-dark block w-full pl-10 pr-10 py-2 text-sm transition-colors ${
                                            fieldErrors.confirmPassword ? 'border-rose-500/60 ring-2 ring-rose-500/15' : ''
                                        }`}
                                        placeholder="Confirm your password"
                                    />
                                    <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute inset-y-0 right-0 pr-3 flex items-center" aria-label={showConfirmPassword ? 'Hide password' : 'Show password'}>
                                        {showConfirmPassword ? (
                                            <svg className="h-5 w-5 text-slate-400 hover:text-slate-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.29 3.29m0 0L3 3m3.29 3.29L3 3" />
                                            </svg>
                            ...
                            <div>
                                <label htmlFor="profileImageUrl" className="block text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">Profile Image URL <span className="text-slate-500 font-normal">(Optional)</span></label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center p-3 bg-white/5 rounded-xl border border-white/10">
                                ...
                                />
                                <label htmlFor="showAdminToken" className="ml-3 block text-sm text-slate-200">I have an admin invite token</label>
                            </div>

                            {showAdminToken && (
                                <div>
                                    <label htmlFor="adminInviteToken" className="block text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">Admin Invite Token</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg className="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-4">
                            <div className="relative my-4">
                                ...
                                <div className="relative flex justify-center text-xs">
                                    <span className="px-3 bg-app-panel2 text-slate-500">Already have an account?</span>
                                </div>
                            </div>
                            <Link
                                to="/login"
                                className="btn-ghost w-full flex justify-center items-center py-2"
                                >
                                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
