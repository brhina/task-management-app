                    ...
                    <div className="max-w-lg">
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-3">
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                                ...
                                <div className="mt-1 text-sm text-slate-400">A consistent sidebar and page layout across all modules.</div>
                            </div>
                            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                                <div className="text-sm font-semibold text-slate-100">Actionable insights</div>
                                <div className="mt-1 text-sm text-slate-400">Charts and KPI chips surface what needs attention.</div>
                            </div>
                        </div>
                    </div>
                </div>
