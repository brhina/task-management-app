    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Active Sprint Card */}
          <div className="card border-l-4 border-l-cyan-500 flex flex-col justify-between">
            <div>
              ...
              {stats.activeSprint ? (
                <div>
                  <div className="text-base font-bold text-slate-800 truncate">{stats.activeSprint.name}</div>
                  <div className="text-xs text-cyan-600 font-medium mt-0.5">
                    {getDaysRemaining(stats.activeSprint.endDate)}
                  </div>
                </div>
              ) : (
                <div className="text-sm font-medium text-slate-400">No active sprint</div>
              )}
            </div>
            {stats.activeSprint && (
          ...
          <div className="card border-l-4 border-l-emerald-500 flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-slate-800">{stats.sprintCompletionRate}%</div>
          ...
          {/* Next Milestone Card */}
          <div className="card border-l-4 border-l-amber-500 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs text-slate-500 mb-1">
              ...
              {stats.nextMilestone ? (
                <div>
                  <div className="text-base font-bold text-slate-800 truncate">{stats.nextMilestone.title}</div>
                ...
                <div className="text-sm font-medium text-slate-400">No pending milestones</div>
              )}
            </div>
            <div className="mt-3 pt-2 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
          ...
          <div className="card border-l-4 border-l-indigo-500 flex flex-col justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-slate-800">{stats.unassignedTasksCount}</div>
              <div className="text-xs text-slate-500 mt-0.5">Tasks ready for sprint assignment</div>
            </div>
            <button
              type="button"
