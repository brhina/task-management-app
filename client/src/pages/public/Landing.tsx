            ...
            <div className="flex flex-col">
                <section className="py-12 lg:py-16">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-lg text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                            A professional task management system designed to help teams and individuals stay organized,
                            productive, and on track with goals.
                        </p>
                ...
                <section className="py-10 lg:py-14">
                    <div className="text-center mb-8">
                        ...
                        <p className="mt-2 text-slate-300">Built for modern workflows, from planning to delivery.</p>
                    </div>
