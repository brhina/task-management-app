    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[10px] text-slate-400 truncate">
                        {currentOrg?.role === 'OrgAdmin' ? 'Admin' : 'Member'} • {orgs.length} org{orgs.length !== 1 ? 's' : ''}
                    </div>
                </div>
                ...
                <>
                    ...
                    <div className="absolute bottom-full left-0 right-0 mb-2 rounded-xl bg-slate-900 border border-white/10 shadow-lg z-50 overflow-hidden">
                        <div className="px-3 py-2 border-b border-slate-700 flex items-center justify-between">
                            <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Organizations</div>
                            <button
                                type="button"
                                onClick={() => setCreateModal({ isOpen: true, name: '', loading: false, error: '' })}
                        ...
                        <div className="max-h-64 overflow-y-auto">
                            {loading ? (
                                ...
                                <div className="px-3 py-4 text-center text-sm text-slate-400">No organizations yet</div>
                            ) : (
                                orgs.map(org => (
            ...
            {showLeaveConfirm && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div className="fixed inset-0 bg-slate-900/80 transition-opacity" onClick={() => setShowLeaveConfirm(null)} />
                            ...
                            <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 className="text-lg font-semibold leading-6 text-white">Leave Organization</h3>
                                        <div className="mt-2">
                                            <p className="text-sm text-slate-400">
                                                Are you sure you want to leave this organization? You will lose access to all its projects and tasks.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            {createModal.isOpen && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div className="fixed inset-0 bg-slate-900/80 transition-opacity" onClick={() => setCreateModal(prev => ({ ...prev, isOpen: false }))} />
                        <div className="relative transform overflow-hidden rounded-xl bg-slate-800 border border-slate-700 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        <h3 className="text-lg font-semibold leading-6 text-white">Create Organization</h3>
                                        <div className="mt-4">
                                            <label htmlFor="orgName" className="block text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">
                                                Organization Name
                                            </label>
                                            <input
                                                type="text"
                                                ...
                                                onChange={(e) => setCreateModal(prev => ({ ...prev, name: e.target.value, error: '' }))}
