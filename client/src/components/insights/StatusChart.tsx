...
export default function StatusChart({
  ...
  const total =
    toNumber(distribution?.all) || pending + inProgress + inReview + completed + overdue;

  const data = [
    {
      key: 'pending' as const,
      name: STATUS_META.pending.label,
      value: pending,
    ...
    },
    {
      ...
      name: STATUS_META.in_review.label,
      value: inReview,
      color: STATUS_META.in_review.color,
      total,
    },
    {
    ...
    },
    {
      ...
      name: STATUS_META.overdue.label,
      value: overdue,
