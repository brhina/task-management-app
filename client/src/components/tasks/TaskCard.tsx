    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-2">
                ...
                <span className={`shrink-0 inline-flex px-1 py-0.5 text-[9px] font-semibold rounded ${getPriorityColor(task.priority)}`}>
            ...
            <div className="flex items-center justify-between gap-2 mt-1.5">
                {task.dueDate && (
                    <span className={`text-[10px] ${dueDateOverdue ? 'text-rose-400 font-medium' : 'text-slate-500'}`}>
