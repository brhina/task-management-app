...
export const apiPaths = {
  ...
  INTELLIGENCE: {
    PLAN_PROJECT: '/api/intelligence/plan-project',
    APPLY_PROJECT_PLAN: '/api/intelligence/plan-project/apply',
    BREAKDOWN_TASK: '/api/intelligence/breakdown-task',
    ANALYZE_RISKS: '/api/intelligence/analyze-risks',
    PLAN_SPRINT: '/api/intelligence/plan-sprint',
    GENERATE_REPORT: '/api/intelligence/reports/:type',
    GENERATE_OKRS: '/api/intelligence/okrs/generate',
    ANALYZE_DEPENDENCIES: '/api/intelligence/dependencies/analyze',
    PORTFOLIO: '/api/intelligence/portfolio',
    ORCHESTRATE: '/api/intelligence/orchestrate',
    RECOMMENDATIONS: '/api/intelligence/recommendations',
    PATCH_RECOMMENDATION: '/api/intelligence/recommendations/:id',
    WORKFLOW_RUN: '/api/intelligence/workflow-runs/:id',
    QUERY: '/api/intelligence/query',
    JOB_RISK_MONITORING: '/api/intelligence/jobs/risk-monitoring',
    JOB_EXECUTIVE_REPORTING: '/api/intelligence/jobs/executive-reporting',
  },
};
