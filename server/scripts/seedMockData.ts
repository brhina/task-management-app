  ...
  try {
    ...
    const tasks = await Task.insertMany([
      ...
      },
      {
        ...
        description:
          "Review dashboard metrics and provide feedback for the next sprint",
        priority: "Medium",
        status: "In Review",
      ...
      },
      {
        ...
        description:
          "Write and review release notes for the upcoming app update",
        priority: "Low",
        status: "Completed",
      ...
      },
      {
        ...
        description:
          "Create compelling landing page copy for the Q2 marketing campaign",
        priority: "Medium",
        status: "Pending",
      ...
      },
      {
        ...
        description:
          "Schedule and conduct user research interviews to gather feedback on the new features",
        priority: "High",
        status: "Pending",
