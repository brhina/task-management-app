...
dependencySchema.index({ orgId: 1, fromTaskId: 1, toTaskId: 1, type: 1 }, { unique: true });

const Dependency = mongoose.model<IDependencyDocument>("Dependency", dependencySchema);
