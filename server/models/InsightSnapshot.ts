...
export interface IInsightSnapshotDocument extends IInsightSnapshot, mongoose.Document {
    createdAt: Date;
    updatedAt: Date;
}
...
insightSnapshotSchema.index({ orgId: 1, scopeType: 1, scopeId: 1, computedAt: -1 });

const InsightSnapshot = mongoose.model<IInsightSnapshotDocument>("InsightSnapshot", insightSnapshotSchema);
