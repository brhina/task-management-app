...
export interface IOrgMembershipDocument extends IOrgMembership, mongoose.Document {
    createdAt: Date;
    updatedAt: Date;
}
...
const OrgMembership = mongoose.model<IOrgMembershipDocument>("OrgMembership", orgMembershipSchema);
